...
final class TableSceneManager
{
    ...
    public function cloneForTable(
        string $sourceTableId,
        string $sourceSceneId,
        string $destinationTableId
    ): TableScene {
        $this->openTable($destinationTableId);
        $source = $this->requiredScene($sourceTableId, $sourceSceneId);

        $scene = $source->isGeneratedSurface()
            ? TableScene::create(
                $this->ids->generate(),
                $destinationTableId,
                $source->name(),
