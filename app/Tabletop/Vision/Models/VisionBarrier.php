...
final class VisionBarrier
{
    ...
    public function __construct(private string $id,private string $sceneId,private string $type,private int $x1,private int $y1,private int $x2,private int $y2,private bool $open=false)
    {
    ...
    public static function reconstitute(array $record):self{return new self((string)($record['id']??''),(string)($record['scene_id']??''),(string)($record['type']??''),(int)($record['x1']??0),(int)($record['y1']??0),(int)($record['x2']??0),(int)($record['y2']??0),(bool)($record['open']??false));}
    ...
    public function x1():int{return $this->x1;} public function y1():int{return $this->y1;} public function x2():int{return $this->x2;} public function y2():int{return $this->y2;}
