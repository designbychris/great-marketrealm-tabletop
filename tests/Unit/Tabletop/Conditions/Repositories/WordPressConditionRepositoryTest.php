...
final class WordPressConditionRepositoryTest extends TestCase {
 ...
 public function testConditionPersistsWithoutAutoload():void {
  $r=new WordPressConditionRepository();$r->save('table',new TokenCondition('token','poisoned',2,new DateTimeImmutable()));
 ...
 public function testSavingSameConditionIsIdempotent():void {
  $r=new WordPressConditionRepository();$r->save('table',new TokenCondition('token','poisoned',2,new DateTimeImmutable()));
  $r->save('table',new TokenCondition('token','poisoned',4,new DateTimeImmutable()));
 ...
 public function testConditionMayBeRemoved():void {
  $r=new WordPressConditionRepository();$r->save('table',new TokenCondition('token','prone',null,new DateTimeImmutable()));
