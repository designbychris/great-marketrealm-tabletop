...
final class SpellPouchPresentationRegressionTest extends TestCase
{
 public function testSatchelUnfurlsAndSpellPouchUsesCompanionProjection(): void
 {
  ...
  self::assertStringContainsString('top:var(--gmrt-satchel-top,7.75rem);bottom:var(--gmrt-satchel-bottom,1rem)', $css); self::assertStringContainsString('height:100%;max-height:none;overflow:auto', $css); self::assertStringContainsString('position:sticky', $css);
 }
}
