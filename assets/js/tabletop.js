(function () {
    ...
    const analyseBattlemapCartography = async () => {
        ...
        const livingContourCandidates = (options = {}) => {
            ...
            const maximumSecondarySeedGenerations=3;
            ...
            if (options.skipOcclusionRecovery !== true) {
                for (let generation=2;generation<=maximumSecondarySeedGenerations;generation+=1) {
                    ...
                    else illustratedIterativeGeneration3Candidates=generationCandidates.length;
                    ...
                    else illustratedIterativeGeneration3Seeds=generationSeeds;
                    ...
                    else illustratedIterativeGeneration3RecoveredCells=generationRecovered;
                ...
                // If generation three was used, distinguish a true budget stop from natural
